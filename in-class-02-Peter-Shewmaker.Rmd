...
```{r}
#This summary gives the average departure delay for all flights, with NA's and negative numbers removed (so for all flights that did have a departure delay).
summarise(flights, average_delay = mean(dep_delay[!is.na(dep_delay) & dep_delay > 0]))
```
